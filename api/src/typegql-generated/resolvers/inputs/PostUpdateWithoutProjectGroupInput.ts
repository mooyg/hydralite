...
import { HashtagsUpdateManyWithoutPostInput } from "../inputs/HashtagsUpdateManyWithoutPostInput";
...
export class PostUpdateWithoutProjectGroupInput {
  ...
  @TypeGraphQL.Field(_type => HashtagsUpdateManyWithoutPostInput, {
    nullable: true
  })
  Topics?: HashtagsUpdateManyWithoutPostInput | undefined;
}
