...
import { ProjectGroupUpsertWithoutMembersInput } from "../inputs/ProjectGroupUpsertWithoutMembersInput";
import { ProjectGroupWhereUniqueInput } from "../inputs/ProjectGroupWhereUniqueInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class ProjectGroupUpdateOneWithoutMembersInput {
  ...
  @TypeGraphQL.Field(_type => ProjectGroupUpsertWithoutMembersInput, {
    nullable: true
  })
  upsert?: ProjectGroupUpsertWithoutMembersInput | undefined;
  ...
  update?: ProjectGroupUpdateWithoutMembersInput | undefined;
}
