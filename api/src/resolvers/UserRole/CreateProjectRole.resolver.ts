...
export default class CreateProjectRoleResolver {
  ...
  async createProjectRole(
    ...
    // validators
    await memberHasManageRolesPermisson(user.id, input.projectId);
